...
(13) 버력을 반출하는 페도차량에는 전방에서 작업중인 근로자에게 미리 접근 상황을 알려주는 통신 및 경보시설을 설치·운용하여야 한다.
...
(5) 강아치지보공의 반침은 목재반침을 금하고 철근류 및 양질의 콘크리트 불
록 등으로 고정하여야 한다.
...
(다) 거푸짐 이동용 궤도는 침하방지를 위하여 지반의 다짐, 편평도를 사전에 점검하고 침묵설치상태, 레일의 간격 등을 사전점검 하여야 한다.
